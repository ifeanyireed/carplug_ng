...
- `GET /api/admin/listings/flagged` — **Protected** (`admin`). Runs algorithmic anomaly detection on vehicle listings, detecting extreme pricing anomalies (< ₦500,000 or > ₦200,000,000), duplicate or missing VIN declarations, unverified uninspected listings, and suspended status.
