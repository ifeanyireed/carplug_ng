...
const BEST_SELLING_MAKES: BestSellingMake[] = [
  {
    ...
    image: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679190/carplug/cars/car19.jpg",
    imageAlt: "White BMW M6 Coupe",
    logo: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679191/carplug/brands/bmw.svg",
    logoAlt: "BMW Logo",
    gridSpan: "top",
  },
  {
    ...
    name: "Toyota",
    startingPrice: "from $50K",
    image: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679191/carplug/cars/car20.jpg",
    imageAlt: "White Toyota C-HR",
    logo: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679199/carplug/brands/toyota.png",
    logoAlt: "Toyota Logo",
    gridSpan: "top",
  },
  {
    ...
    image: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679184/carplug/cars/car12.jpg",
    imageAlt: "White Mercedes-Benz C-Class",
    logo: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679197/carplug/brands/mercedes.png",
  ...
  },
  {
    ...
    name: "Lexus",
    startingPrice: "from $50K",
    image: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679183/carplug/cars/car11.jpg",
    imageAlt: "Green Mini Cooper in City",
    logo: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679196/carplug/brands/lexus.png",
    logoAlt: "Lexus Logo",
    gridSpan: "bottom",
  },
  {
    ...
    image: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679182/carplug/cars/car10.jpg",
    imageAlt: "Grey Ford Ranger Pickup",
    logo: "https://res.cloudinary.com/cgiq8vwf/image/upload/v1789679194/carplug/brands/ford.svg",
    logoAlt: "Ford Logo",
    gridSpan: "bottom",
  },
];
